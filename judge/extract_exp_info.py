...
def main():
    ...
    ap.add_argument("--out-dir", default="judge/results/evaluation_videos",
    ...
    ap.add_argument("--reference-dir", default="", help="Dir containing vid_{id}_ref.mp4 files (optional).")
    ...
    runner_filename = f"run_all_authors_{author_slug}_target_{eval_slug}.sh"
